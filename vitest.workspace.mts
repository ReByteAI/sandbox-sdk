...
export default defineWorkspace([
  ...
  },
  {
    test: {
      ...
      provide: {
        REBYTE_SANDBOX_API_KEY: process.env.REBYTE_SANDBOX_API_KEY || env.parsed?.REBYTE_SANDBOX_API_KEY,
        REBYTE_SANDBOX_DOMAIN: process.env.REBYTE_SANDBOX_DOMAIN || env.parsed?.REBYTE_SANDBOX_DOMAIN,
      },
    },
  },
  {
