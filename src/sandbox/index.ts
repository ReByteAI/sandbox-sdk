...
export class Sandbox extends SandboxApi {
   ...
   */
  async pause(opts?: ConnectionOpts): Promise<string | false> {
   ...
   */
  async hibernate(opts?: ConnectionOpts): Promise<string | false> {
    return await SandboxApi.hibernate(this.sandboxId, { ...this.connectionConfig, ...opts })
  }
