...
function buildTemplate(
  ...
  return Template.build(template, {
    alias: options?.alias || `rebyte-test-${randomUUID()}`,
    cpuCount: 1,
    memoryMB: 1024,
...
export const isDebug = process.env.REBYTE_SANDBOX_DEBUG !== undefined
export const isIntegrationTest = process.env.REBYTE_SANDBOX_INTEGRATION_TEST !== undefined
