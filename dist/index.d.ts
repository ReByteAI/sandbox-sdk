...
interface components {
    schemas: {
        ...
        NewSandbox: {
            ...
            /**
             * @description How to handle timeout. "pause" = full snapshot, "hibernate" = rootfs-only.
             * @enum {string}
             */
        ...
        SandboxNetworkConfig: {
            /** @description List of allowed domains for egress traffic. Supports exact match, wildcard "*", and suffix "*.example.com". Domains bypass all CIDR checks. */
            ...
            /** @description List of denied CIDR blocks or IP addresses for egress traffic. Use ["0.0.0.0/0"] for whitelist mode. */
            denyOut?: string[];
...
declare const ErrorCode: {
    readonly NO_ORCHESTRATOR: "no_orchestrator";
    readonly ORCHESTRATOR_UNREACHABLE: "orchestrator_unreachable";
    readonly SANDBOX_NOT_FOUND: "sandbox_not_found";
    readonly SANDBOX_ALREADY_RUNNING: "sandbox_already_running";
    readonly SANDBOX_PAUSING: "sandbox_pausing";
    readonly SANDBOX_KILLING: "sandbox_killing";
    readonly CONCURRENT_OPERATION: "concurrent_operation";
    readonly INVALID_STATE_TRANSITION: "invalid_state_transition";
    readonly TRANSITION_FAILED: "transition_failed";
    readonly CREATE_FAILED: "create_failed";
    readonly RESUME_FAILED: "resume_failed";
    readonly PAUSE_FAILED: "pause_failed";
...
declare class SandboxApi {
     ...
     */
    static pause(sandboxId: string, opts?: SandboxApiOpts): Promise<string | false>;
    /**
     * @beta This feature is in beta and may change in the future.
     *
     ...
     */
    static hibernate(sandboxId: string, opts?: SandboxApiOpts): Promise<string | false>;
...
declare class Sandbox extends SandboxApi {
     ...
     */
    pause(opts?: ConnectionOpts): Promise<string | false>;
    /**
     * @beta This feature is in beta and may change in the future.
     *
     ...
     */
    hibernate(opts?: ConnectionOpts): Promise<string | false>;
    /**
     *
